...
csv_directory = 'phase_segmentation_csv_data/*.csv'
...
X = shuffled_df.drop('Phase',axis=1)
y = shuffled_df['Phase']
...
dump(rf_model, 'phase_segmentation_random_forest_model.joblib')
...
test_prob_df = pd.DataFrame(test_probabilities, columns=['Lifting', 'Moving', 'Placing'])
test_prob_df.head()
